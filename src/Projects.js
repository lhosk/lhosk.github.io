  ...
  return (
    <div style={{...style_background}}>
      ...
      <ul style={stylet_project_links}>
        ...
        <li>
            <Link to="/atari_rl" style = {stylet_link_separation}>
            Reinforcement Learning Using Atari</Link>

            <Link to="/connect_four" style = {stylet_link_separation}>
            Connect Four with MiniMax and AB Pruning </Link>

            <Link to="/mcs_matlab" style = {stylet_link_separation}>
            Matlab: Monte Carlo Simulation to Predict Size of Circles and Spheres</Link>

            <Link to="/mcsapf" style = {stylet_link_separation}>
            Arduino: Monte Carlo Simulation for Atomic Packing Factors</Link>

            <Link to="/parallel" style = {stylet_link_separation}>
            Parallel Computing on an HPC Using Pthreads and openMP</Link>

            <Link to="/recipe_rec" style = {stylet_link_separation}>
            Recipe Recommendation Using NLP</Link>

            <Link to="/red_light_green_light" style = {stylet_link_separation}>
            Arduino: Red Light Green Light</Link>

            <Link to="/vrd" style = {stylet_link_separation}>
